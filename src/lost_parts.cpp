 ...
 * @brief This file contains the implementation of the LostParts class that publishes messages
 *        at regular intervals using ROS 2.
 * @version 1.0
 * @date 2024-11-24
 * @copyright Copyright (c) 2024
 *
 * This file provides the implementation of the LostParts class, which creates a ROS 2
 ...
 * 
 * The LostParts class initializes a ROS 2 node that publishes messages at a user-defined
 ...
 * 
 * Initializes the ROS 2 system, creates an instance of the LostParts node, and starts
