/**
 * @file warehouse_head.cpp
 * @author Datta Lohith Gannavarapu, Dheeraj Vishnubhotla, Nazrin Gurbanova
 * @brief This file contains the implementation of the WarehouseHead class that publishes messages
 *        at regular intervals using ROS 2.
 * @version 1.0
 * @date 2024-11-24
 * @copyright Copyright (c) 2024
 *
 * This file provides the implementation of the WarehouseHead class, which creates a ROS 2
 ...
 * 
 * The WarehouseHead class initializes a ROS 2 node that publishes messages at a user-defined
 ...
 * 
 * Initializes the ROS 2 system, creates an instance of the WarehouseHead node, and starts
...
int main(int argc, char *argv[]) {
  ...
  auto node = std::make_shared<WarehouseHead>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
